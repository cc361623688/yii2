...
<div class="panel">
    ...
    <div class="pannel-boy">
        ...
        <textarea onmousedown="focusfirst(event,this)" name="" id="feed-content" cols="30" rows="10" class="form-control" name="content">
        ...
        <?php if(!empty($data['feed'])):?>
            <ul class="blog-feed-list media-list media-feed feed-index ps-container ps-active-y">
